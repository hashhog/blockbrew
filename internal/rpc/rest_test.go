...
func TestRESTTx(t *testing.T) {
	...
	// Output: OP_RETURN <4-byte payload> — standard nulldata, never dust,
	// value=0. Non-witness size: 4+1+36+1+4+1+8+1+6+4 = 66 bytes ≥ 65.
	// UTXO scriptPubKey: OP_1 (anyone-can-spend, valid for script eval).
	...
	utxoView.AddUTXO(tx.TxIn[0].PreviousOutPoint, &consensus.UTXOEntry{
		Amount:   1_100_000,      // total input; fee = 1_100_000 - 0 = 1_100_000 sat
